...
[Advisory cross-reference](#8-advisory-cross-reference)) and exist to prevent that
...
- [Policy enforcement](../admin/policy.md) and
  [ADR 0002](../adr/0002-open-policy-agent.md)
...
section of the
[pull-request template](https://github.com/openstack-experimental/keystone/blob/main/.github/pull_request_template.md)
